...
for split in ['time','random']:
    for model in ['Neurlux', 'Transformer', 'JsonGrinder']:
        ...
        plt.xlabel('False Positive Rate (Positive label: 1)',fontsize=15)
        plt.ylabel('True Positive Rate (Positive label: 1)',fontsize=15)
...
for split in ['time', 'random']:
    for model in ['Neurlux', 'Transformer', 'JsonGrinder']:
        ...
        plt.xlabel('False Positive Rate (Positive label: 1)', fontsize=15)
        plt.ylabel('False Negative Rate (Positive label: 1)', fontsize=15)
